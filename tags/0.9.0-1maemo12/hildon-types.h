...
GType hildon_time_selector_format_policy_get_type (void) G_GNUC_CONST;
#define HILDON_TYPE_TIME_SELECTOR_FORMAT_POLICY (hildon_time_selector_format_policy_get_type())
